...
public class ApplicationController {
    ...
    public String handlePreLogin() {
        LOGGER.info("==== pre-login ====");
        return createResponse();
    }

    @RequestMapping(value = "/quick-login", method = RequestMethod.GET)
    public String handleQuickLogin() {
        LOGGER.info("==== quick-login ====");
        return createResponse();
    }

    @RequestMapping(value = "/full-login", method = RequestMethod.GET)
    public String handleFullLogin() {
